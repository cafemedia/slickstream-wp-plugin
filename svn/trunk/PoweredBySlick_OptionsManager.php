...
if ($optionMetaData != null) {
        ...
        ?>
            ...
            <p>If you have any problems installing, configuring, or styling your widgets, please <a href="mailto:support@poweredbyslick.com">contact us</a>.  We're happy to help!</p>
        </div>
        <?php
}
