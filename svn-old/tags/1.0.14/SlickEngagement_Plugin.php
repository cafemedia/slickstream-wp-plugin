...
// Ensure pages can be configured with categories and tags
    ...
    {
        return '<div class="slick-widget slick-game slick-shortcode"></div>';
    }
...
/*If there's a featured image, show it*/
    ...
    public function addSlickPageHeader()
    {
        ...
        echo "\n";
        echo '<meta property="slick:wpversion" content="1.0.14" />' . "\n";
        if ($siteCode) {
            $serverUrl = $this->getOption('SlickServerUrl', 'https://app.slickstream.com/e2/embed-nav.js');
